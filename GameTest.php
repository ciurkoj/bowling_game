...
class GameTest extends TestCase
{
    ...
    function test_it_scores_a_gutter_game_as_zero()
    {
        $game = new Game();
    ...
    function test_it_scores_all_ones()
    {
        $game = new Game();
    ...
    function test_it_scores_a_perfect_game()
    {
        $game = new Game();
    ...
    function test_it_awards_a_two_roll_bonus_for_every_strike()
    {
        $game = new Game();
    ...
    function test_a_spare_on_the_final_frame_grants_one_extra_ball()
    {
        $game = new Game();
    ...
    function test_a_strike_on_the_final_frame_grants_two_extra_balls()
    {
        $game = new Game();
